            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <img className="w-10 rounded-2xl h-10" src="https://i.ibb.co/bRYjqzXg/pexels-pixabay-56866.jpg" alt="logo" />
                        <span className="self-center text-2xl font-semibold"> Awesome Flowers</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-start space-x-3">
                            ...
                            <Link rel="noopener noreferrer" to="https://www.instagram.com/" title="Instagram" className="flex items-center p-1">
